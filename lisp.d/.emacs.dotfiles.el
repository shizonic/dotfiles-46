(defun dotfiles-install ()
  ...
  (setq dotfiles-bash-profile "
  export EDITOR=emacsclient
  export VISUAL=emacsclient
  export PATH=/home/adam/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl
  ...
  (setq dotfiles-icons-default-index-theme "
  \[Icon Theme]
  Name=Default
  ...
  (setq dotfiles-gnupg-gpg-agent-conf "
  ...
  (setq dotfiles-config-gtk-3-0-settings "
  \[Settings]
